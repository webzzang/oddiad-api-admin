...
@Data
public class PartnerDeviceAddReq {
  ...
  @ApiModelProperty(value = "기기타입", position = 4)
  private String type;

  @ApiModelProperty(value = "등록일", position = 5)
  private String regDate;

  @ApiModelProperty(value = "화면분할", position = 6)
  private String displayDiv;

  @ApiModelProperty(value = "우측화면", position = 7)
  private String sideContentsType;

  @ApiModelProperty(value = "아래쪽화면", position = 8)
