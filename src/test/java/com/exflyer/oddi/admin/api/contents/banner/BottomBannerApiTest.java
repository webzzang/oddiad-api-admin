...
class BottomBannerApiTest {
  ...
  @DisplayName("광고판 하단 배너관리 사용 코드 조회")
  @Test
  public void findCodeList() throws Exception {
    MvcResult mvcResult = mockMvc
        .perform(
            MockMvcRequestBuilders.get("/bottom-banner/search-codes")
  ...
  public void findSearchSideBanner() throws Exception {
    ...
    MvcResult mvcResult = mockMvc
        .perform(
            MockMvcRequestBuilders.get("/bottom-banner/search")
                .header(TokenGenerator.Header, tokenGenerator.getTestToken())
                .contentType(MediaType.APPLICATION_JSON)
  ...
  @DisplayName("광고판 하단 배너관리 상세 조회")
  @Test
  public void findDetail() throws Exception {

    MvcResult mvcResult = mockMvc
        .perform(
            MockMvcRequestBuilders.get("/bottom-banner/1")
                .header(TokenGenerator.Header, tokenGenerator.getTestToken())
                .contentType(MediaType.APPLICATION_JSON)
        )
        .andDo(print())
  ...
  @DisplayName("광고판 하단 배너관리 등록")
  @Test
  public void save() throws Exception {

    BannerRegReq regReq = new BannerRegReq();
    regReq.setName("웹 하단 배너 등록");
    ...
    MvcResult mvcResult = mockMvc
        .perform(
            MockMvcRequestBuilders.post("/bottom-banner")
                .header(TokenGenerator.Header, tokenGenerator.getTestToken())
                .contentType(MediaType.APPLICATION_JSON)
  ...
  @DisplayName("광고판 하단 배너관리 수정")
  @Test
  public void modify() throws Exception {

    BannerRegReq modReq = new BannerRegReq();
    modReq.setName("[수정] 웹 하단배너 수정");
    modReq.setFileSeq(7L);
    ...
    MvcResult mvcResult = mockMvc
        .perform(
            MockMvcRequestBuilders.put("/bottom-banner/6")
                .header(TokenGenerator.Header, tokenGenerator.getTestToken())
                .contentType(MediaType.APPLICATION_JSON)
