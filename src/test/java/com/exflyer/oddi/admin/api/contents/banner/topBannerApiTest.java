...
class topBannerApiTest {
  ...
  @DisplayName("광고판 상단 배너관리 사용 코드 조회")
  @Test
  public void findCodeList() throws Exception {
    MvcResult mvcResult = mockMvc
        .perform(
            MockMvcRequestBuilders.get("/top-banner/search-codes")
  ...
  public void findSearchSideBanner() throws Exception {
    ...
    MvcResult mvcResult = mockMvc
        .perform(
            MockMvcRequestBuilders.get("/top-banner/search")
                .header(TokenGenerator.Header, tokenGenerator.getTestToken())
                .contentType(MediaType.APPLICATION_JSON)
  ...
  @DisplayName("광고판 상단 배너관리 상세 조회")
  @Test
  public void findDetail() throws Exception {

    MvcResult mvcResult = mockMvc
        .perform(
            MockMvcRequestBuilders.get("/top-banner/1")
                .header(TokenGenerator.Header, tokenGenerator.getTestToken())
                .contentType(MediaType.APPLICATION_JSON)
        )
        .andDo(print())
  ...
  @DisplayName("광고판 상단 배너관리 등록")
  @Test
  public void save() throws Exception {

    BannerRegReq regReq = new BannerRegReq();
    regReq.setName("웹 상단 배너 등록");
    regReq.setFileSeq(7L);
    regReq.setUsable(true);
    regReq.setExpoStartDate("20211201");
    regReq.setExpoEndDate("20211231");
    regReq.setMemo("새로운 등록 메모입니다.");
    regReq.setDescription("노출 텍스트입니다.");
    regReq.setButtonName("노출버튼");
    regReq.setRouterLink("https://naver.com");

    MvcResult mvcResult = mockMvc
        .perform(
            MockMvcRequestBuilders.post("/top-banner")
                .header(TokenGenerator.Header, tokenGenerator.getTestToken())
                .contentType(MediaType.APPLICATION_JSON)
